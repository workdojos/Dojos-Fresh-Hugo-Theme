---
title: Administrator's Dojo
description: Making open-source more accessible.
include_footer: false
sidebar: false
layout: single2
---
<iframe src="https://administrators.workdojos.com" style="width: 100%;height: 960px;padding: 8px; box-shadow: 0 3px 5px rgba(0,0,0,.6);border-radius: 25px;overflow: hidden;border: none;" align="middle"></iframe>
<br>
...
<figure>
    <blockquote cite="">
        <p></p>
    {{% subtitle5 "Take Administration to the next level." %}}
Administration is held near and dear to us!  Our primary objective when approaching a new tool is how can that tool improve our level of organization, and you guessed, administration!

Enter a new world filled with new opportunities.  An administrator's dream.  Open-source tools, on your own server, that you control.  It starts with a dashboard in your Work Dojo.
</figure>
...
<br><br>
 ...
 <a href="https://workdojos.com/Adventurers">Next Dojo</a> 
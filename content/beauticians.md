---
title: Beautician's Dojo
description: Making open-source more accessible.
include_footer: true
sidebar: true
sidebarlogo: wordojos_logo
---
<iframe src="https://beauticians.workdojos.com" style="width: 100%;height: 630px;padding: 8px; box-shadow: 0 3px 5px rgba(0,0,0,.6);border-radius: 25px;overflow: hidden;border: none;" align="middle"></iframe>
<br>
...
<figure>
    <blockquote cite="">
        <p></p>
    {{% subtitle5 "A slick digital presence (and toolkit) for any aspiring beautician." %}}
Distilling down all the info in the beauty industry is a challenge!  We aim to provide a solid foundation for any career (or passion project) related to the fashion & beauty industry.

It all starts with a dashboard that you own and control on your own server.  Includes a chat app so that you can start a following.  Your Dojo also includes a blog with payments and subscriptions built in.  Like we said, one great foundation for all things beauty!
</figure>
...
<br><br>
 ...
 <a href="https://workdojos.com/Beergarden">Next Dojo</a> 
...
---
<figure>
    <img src='/uploads/recommendations.jpg' height="100%" width="500px";padding="3px"; box-shadow= "0 3px 5px rgba(0,0,0,.3)";border-radius= "55px";overflow= "hidden";border= "none"; alt='firecracker';/>

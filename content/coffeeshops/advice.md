...
---
<figure>
    <img src='/uploads/recommendations.jpg' style="width: 90%;height: 90%;padding: 3px; box-shadow: 0 3px 5px rgba(0,0,0,.3);border-radius: 25px;overflow: hidden;border: none;" align="middle"; alt='alt';padding="3px"; box-shadow= "0 3px 5px rgba(0,0,0,.3)";border-radius= "55px";overflow= "hidden";border= "none"; alt='firecracker';/>

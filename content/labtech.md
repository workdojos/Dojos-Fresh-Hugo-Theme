---
title: Lab Tech's Dojo
description: Making open-source more accessible.
include_footer: false
sidebar: false
sidebarlogo: wordojos_logo
---
<iframe src="https://labtech.workdojos.com" style="width: 100%;height: 960px;padding: 8px; box-shadow: 0 3px 5px rgba(0,0,0,.6);border-radius: 25px;overflow: hidden;border: none;" align="middle"></iframe>
<br>
...
<figure>
    <blockquote cite="">
        <p></p>
    {{% subtitle5 "Ever considered starting a business in the medical field?" %}}
With open-source self-hosted technology you can!  Work Dojos mission is to equip you with the tools to start a business, or passion project, or simply create a dashboard that you own and control.

With a single self-hosted GUI, you're in the driver seat and you decide what your eyeballs get to feast upon.  It's the future!  And might even be the future of lab testing and diagnostics.  Already seeing them on my smartwatch!

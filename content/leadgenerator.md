---
title: Lead Generator's Dojo
include_footer: true
sidebar: true
sidebarlogo: wordojos_logo
description: Making open-source more accessible.
---
<iframe src="https://leadgenerator.workdojos.com" style="width: 100%;height: 630px;padding: 8px; box-shadow: 0 3px 5px rgba(0,0,0,.6);border-radius: 25px;overflow: hidden;border: none;" align="middle"></iframe>
<br>
...
<figure>
    <blockquote cite="">
        <p></p>
    {{% subtitle5 "A guided process into the art of lead generation.  Self-hosted on open-source technology." %}}
The lead gen business is cuthroat!  You need all the tools and tech savvy skills that you can get.  The smartest foundation for any tech savvy business owner is to manage their own servers.  This gives you access to open-source apps that can be used as building blocks.
description: Making open-source more accessible.

It all starts with a dashboard and a Dojo.
</figure>
...
<br><br>
 ...
 <a href="https://workdojos.com/legislator">Next Dojo</a> 
---
title: Logistician's Dojo
description: Making open-source more accessible.
include_footer: true
sidebar: true
sidebarlogo: wordojos_logo
---
<iframe src="https://logistician.workdojos.com" style="width: 100%;height: 630px;padding: 8px; box-shadow: 0 3px 5px rgba(0,0,0,.6);border-radius: 25px;overflow: hidden;border: none;" align="middle"></iframe>
<br>
...
<figure>
    <blockquote cite="">
        <p></p>
    {{% subtitle5 "Navigating logistics doesn't have to be complicated." %}}
This Dojo features a toolkit for both existing and aspiring logisticians alike!  Want to become a logistician?  Great!  Want a customized dashboard for your existing job in logistics?  Fantastic!

It all starts with a dashboard.  Built with open-source technology that you own and control.  Who's going to get your eyeballs?  You decide!
</figure>
...
<br><br>
 ...
 <a href="https://workdojos.com/lyricist">Next Dojo</a> 
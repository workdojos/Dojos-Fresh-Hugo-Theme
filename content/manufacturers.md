---
title: Manufacturer's Dojo
description: Making open-source more accessible.
include_footer: true
sidebar: true
sidebarlogo: wordojos_logo
---
<iframe src="https://manufacturers.workdojos.com" style="width: 100%;height: 630px;padding: 8px; box-shadow: 0 3px 5px rgba(0,0,0,.6);border-radius: 25px;overflow: hidden;border: none;" align="middle"></iframe>
<br>
...
<figure>
    <blockquote cite="">
        <p></p>
    {{% subtitle5 "Hub for all things manufacturing.  Your hub!" %}}
A self-hosted hub is a great way to organize all your manufacturing activities, suppliers, tools, and more, in one place.  Built with open-source tech, it all starts with a dashboard.

A dashboard that you own and control.  Put the info that's most important to you, your family, and your business front and center.

There's more.  The dashboard is just the beginning..!  Ready to manufacture something?
...
<br><br>
 ...
 <a href="https://workdojos.com/mediabuyer">Next Dojo</a> 
---
title: Novelist's Dojo
description: Making open-source more accessible.
include_footer: true
sidebar: true
sidebarlogo: wordojos_logo
---
<iframe src="https://novelist.workdojos.com" style="width: 100%;height: 630px;padding: 8px; box-shadow: 0 3px 5px rgba(0,0,0,.6);border-radius: 25px;overflow: hidden;border: none;" align="middle"></iframe>
<br>
...
<figure>
    <blockquote cite="">
        <p></p>
    {{% subtitle5 "Want to write a novel in your free time?" %}}
We can help you do that!  Novelist's Dojo is for all the aspiring novelists out there.  We have curated a quick-start guide to writing a novel.  We serve that and more up to you in a suite of open-source products that you will own and control.

What's in your Dojo, ghostwriter?
</figure>
        ...
        <td align="center" valign="top" width="50%" class="templateColumnContainer">
            <table border="0" cellpadding="10" cellspacing="0" width="100%">
                ...
                <tr>
                    <td valign="top" class="rightColumnContent">
                        <h1>Chat.</h1>
                        Workmates, built with Rocket.chat. 1k+ channels for countries and jobs. 
                    </td>
                </tr>
            </table>
        </td>

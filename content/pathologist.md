---
title: Pathologist's Dojo
description: Making open-source more accessible.
include_footer: false
sidebar: false
layout: single2
---
<iframe src="https://pathologist.workdojos.com" style="width: 100%;height: 960px;padding: 8px; box-shadow: 0 3px 5px rgba(0,0,0,.6);border-radius: 25px;overflow: hidden;border: none;" align="middle"></iframe>
<br>
...
<figure>
    <blockquote cite="">
        <p></p>
    {{% subtitle5 "Another resource for pandemic preparedness." %}}
If the pandemic has taught us anything it's that viruses can be pretty nasty!  Pathologist's Dojo is dedicated to the study of these little bastards.  For the next flare up, make sure you got all the tools and all the right information.

It all starts with a dashboard.  And that's just the beginning.
...
<br><br>
 ...
 <a href="https://workdojos.com/Pharmacists">Next Dojo</a> 
---
title: Photo Journalist's Dojo
description: Making open-source more accessible.
include_footer: true
sidebar: true
sidebarlogo: wordojos_logo
---
<iframe src="https://photojournalist.workdojos.com" style="width: 100%;height: 630px;padding: 8px; box-shadow: 0 3px 5px rgba(0,0,0,.6);border-radius: 25px;overflow: hidden;border: none;" align="middle"></iframe>
<br>
...
<figure>
    <blockquote cite="">
        <p></p>
    {{% subtitle5 "A dashboard for photo journalists." %}}
Premium SaaS services are great, but the costs can add up.  Especially if you're trying to equip a team of multiple seats.  Most SaaS companies charge per seat.

With open-source technology you can eke out every bit of server space.  That works out great for photo journalists because of the massive amount of content that we churn through.  It all starts with a dashboard, customized for you.

What else is in your Dojo, photo journalist?
</figure>
...
<br><br>
 ...
 <a href="https://workdojos.com/Physicaltherapist">Next Dojo</a> 
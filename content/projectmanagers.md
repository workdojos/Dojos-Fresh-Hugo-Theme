---
title: Project Manager's Dojo
description: Making open-source more accessible.
include_footer: true
sidebar: true
sidebarlogo: wordojos_logo
---
<iframe src="https://projectmanagers.workdojos.com" style="width: 100%;height: 630px;padding: 8px; box-shadow: 0 3px 5px rgba(0,0,0,.6);border-radius: 25px;overflow: hidden;border: none;" align="middle"></iframe>
<br>
...
<figure>
    <blockquote cite="">
        <p></p>
    {{% subtitle5 "Every project manager needs his/her own "Hub."" %}}
Or as we like to call, a "Dojo."  It all starts with a dashboard.  Customised to you, your profession, and your projects.

And the dashboard is just the beginning!

Don't settle for siloed experiences dictated by your big tech providers.  Microsoft, Google, Apple, here's looking at you!  Self-host your own technology.  Flex as the ULTIMATE project manager by managing your own tech stack.

Each Dojo includes an entire suite of open-source tools that will take your project management game to the next level and beyond.
        ...
        <td align="center" valign="top" width="50%" class="templateColumnContainer">
            <table border="0" cellpadding="10" cellspacing="0" width="100%">
                ...
                <tr>
                    <td valign="top" class="rightColumnContent">
                        <h1>Chat.</h1>
                        Workmates.  Channels for every country and every job.
                    </td>
                </tr>
            </table>
        </td>
...
<br><br>
 ...
 <a href="https://workdojos.com/Publicrelations">Next Dojo</a> 
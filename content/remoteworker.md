---
title: Remote Worker's Dojo
description: Making open-source more accessible.
include_footer: true
sidebar: true
sidebarlogo: wordojos_logo
---
<iframe src="https://remoteworker.workdojos.com" style="width: 100%;height: 630px;padding: 8px; box-shadow: 0 3px 5px rgba(0,0,0,.6);border-radius: 25px;overflow: hidden;border: none;" align="middle"></iframe>
<br>
...
<figure>
    <blockquote cite="">
        <p></p>
    {{% subtitle5 "Are you a freelancer, digital nomad, or aspiring entrepreneur?" %}}
Ever digital nomad needs a dashboard.  Not just any dashboard but one that you own and control.  Built onto your own server, and backed up by a suite of open-source apps that are yours.

A remote worker with a solid tech stack is a remote worker with a bright feature.  From websites, to chat apps, productivity apps, and more, your Dojo is packed and costs just $25/month.
</figure>
...
<br><br>
 ...
 <a href="https://workdojos.com/Researchers">Next Dojo</a> 
---
title: School Teacher's Dojo
description: Making open-source more accessible.
include_footer: false
sidebar: false
sidebarlogo: wordojos_logo
---
<iframe src="https://schoolteachers.workdojos.com" style="width: 100%;height: 960px;padding: 8px; box-shadow: 0 3px 5px rgba(0,0,0,.6);border-radius: 25px;overflow: hidden;border: none;" align="middle"></iframe>
<br>
...
<figure>
    <blockquote cite="">
        <p></p>
    {{% subtitle5 "The absolute best education you can provide to students when it comes to technology is teaching them how to self-host technology." %}}
Self-hosting means deploying apps and websites on your own server.  Often times driven by a Linux terminal which can look scary but it shouldn't.

Kids and adults alike can become comfortable hosting servers.  It gives you control.  It gives you building blocks.  It gets those creative juices flowing.  

With open-source technology, anything is possible.  Want to start your own educational Dojo?  We can get you up and running for a flat $25/month.
...
<br><br>
 ...
 <a href="https://workdojos.com/Socialnetworks">Next Dojo</a> 
---
title: Strategist's Dojo
description: Making open-source more accessible.
include_footer: true
sidebar: true
sidebarlogo: wordojos_logo
---
<iframe src="https://strategists.workdojos.com" style="width: 100%;height: 630px;padding: 8px; box-shadow: 0 3px 5px rgba(0,0,0,.6);border-radius: 25px;overflow: hidden;border: none;" align="middle"></iframe>
<br>
...
<figure>
    <blockquote cite="">
        <p></p>
    {{% subtitle5 "Put your consulting skills to use." %}}
Everybody's an armchair expert, but it takes chops to be called a consultant!

We equip aspiring consultants with an arsenal of tools.  Open-source apps, websites, dashboards, you name it, and we customize it for you.

Wow your prospective clients, put information front and center where you want it, level up your consulting game.
...
<br><br>
 ...
 <a href="https://workdojos.com/Supportgroup">Next Dojo</a> 